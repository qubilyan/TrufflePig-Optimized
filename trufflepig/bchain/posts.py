...
Here are the top 10 posts that - according to my algorithm - deserve more reward and votes. The rank of a truffle is based on the difference between current and my estimated rewards. In addition, the rank is slightl